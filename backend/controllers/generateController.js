...
Plan (P): Detail the treatment plan, any follow-up instructions, and patient education provided by the doctor. Please do not include any other text, and just directly give me these organized patient notes in bulletin point.
Only add newlines to separate each of the described sections above, otherwise don’t add any newline character. Do not hallucinate and don’t make up anything else that is not present within the following text. This text was generated by a speech-to-text model:
\n\n"${originalText}"`;
